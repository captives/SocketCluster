...
module.exports = KurentoServer;
function KurentoServer (){
    this.init = init;
    this.stop = stop;
    this.publish = publish;
    this.subscribe = subscribe;
    this.iceCandidate = onIceCandidate;
    ...
    function init(_argv){
        ...
        getKurentoClient(function () {
            console.log('KurentoServerManager ## kurento server startup success', _argv.ws_uri);
        });
    }
    ...
    function startPresenter(sessionId, sdpOffer, sendMessage, callback) {
        // console.log('startPresenter', sessionId, sdpOffer);
        //清空candidates队列
        clearCandidatesQueue(sessionId);
        ...
        getKurentoClient(function(error, kurentoClient) {
            ...
            // console.log('startPresenter333', presenter, kurentoClient);
            kurentoClient.create('MediaPipeline', function(error, pipeline) {
                // console.log('kurentoClient # MediaPipeline', error, pipeline);
                if (error) {
                    stop(sessionId);
                    return callback(error);
                }
                ...
                // console.log('startPresenter444', presenter, presenter.pipeline);
